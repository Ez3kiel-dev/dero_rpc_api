...
Future<void> main() async {
  ...
  test('getHeight Derod', () async {
    ...
    var res = await derodRepository.getHeight();
    // print(res);
  ...
  test('getBlock Derod', () async {
    await expectLater(
        derodRepository.getBlock(GetBlockParams(height: 0)), completes);
  ...
  test('getSC Derod', () async {
    var params = GetSCParams(scid: scidOfficialNameService);
  ...
  test('getEncryptedBalance Derod', () async {
    ...
    var params = GetEncryptedBalanceParams(address: addresses.address![0]);
